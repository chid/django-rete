...
FIELDS = list(zip(FIELD_INDEXES, FIELD_NAMES))
FIELD_IDX_TO_NAME = dict(list(zip(FIELD_INDEXES,FIELD_NAMES)))
FIELD_NAME_TO_IDX = dict(list(zip(FIELD_NAMES,FIELD_INDEXES)))
